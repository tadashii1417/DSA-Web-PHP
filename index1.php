...
<div class="main">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top nbar">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="space"><a><i class="fa fa-code ispace"></i>Xem điểm</a></li>
    </ul>
...
<form enctype="multipart/form-data" id="form_upload" name="f2" method="POST" >
	...
	<input type="submit" name="submit" id="st" class="btn btn-success" value="Submit"><br><br><br>
         ...
         ?>
    <input type="button" name="score" id="score" class="btn btn-success" onclick="myAjax()" value="Compile"><br><br><br>
...
if(isset($_POST['submit']))
{
	...
	echo '<pre>';
	echo "Kết quả: ";
	$text=fopen($thisdir . "/uploaded/".$mssv."/submit_".$now."/output/score.txt", 'r');
	echo fgets($text);
	echo '</pre>';
	fclose($text);
